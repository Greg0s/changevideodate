...
const it: Translation = {
  ...
  install: {
    alreadyInstalled: "Ho già ExifTool installato",
    tooltip: "Lascia deselezionato se non sei sicuro.",
  },
  filePath: {
    label: "Percorso file",
    getPath: "Ottieni il percorso:",
    dragHint: "oppure trascina qui il file",
    dropActive: "Rilascia per compilare il nome del file",
  },
  pathTooltip: {
    windows: {
